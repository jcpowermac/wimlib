...
static int
do_free_lookup_table_entry(struct blob_info *entry, void *ignore)
{
...
struct blob_info *
clone_lookup_table_entry(const struct blob_info *old)
{
...
void
free_lookup_table_entry(struct blob_info *blob)
{
	if (blob) {
